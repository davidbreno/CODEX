      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="flex flex-col text-sm font-medium text-white/80">
            Categoria
            <input
              className="mt-1 rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-aurora-end focus:outline-none focus:ring-2 focus:ring-aurora-end/50"
              name="category"
        ...
        <label className="flex flex-col text-sm font-medium text-white/80">
          ...
          <select
            className="mt-1 rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-sm text-white focus:border-aurora-end focus:outline-none focus:ring-2 focus:ring-aurora-end/50"
            name="billId"
        ...
        <label className="flex flex-col text-sm font-medium text-white/80">
          Descrição
          <textarea
            className="mt-1 min-h-[96px] rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-aurora-end focus:outline-none focus:ring-2 focus:ring-aurora-end/50"
            name="description"
        ...
        {amountPreview && <p className="text-sm text-white/60">Valor equivalente: {amountPreview}</p>}

        {errorMessage && <p className="text-sm text-rose-400">{errorMessage}</p>}
        {successMessage && <p className="text-sm text-emerald-400">{successMessage}</p>}

        <button
          className="inline-flex items-center justify-center rounded-xl bg-rose-500 px-5 py-2 text-sm font-semibold text-midnight transition hover:bg-rose-400 disabled:cursor-not-allowed disabled:bg-rose-700/60"
          type="submit"
